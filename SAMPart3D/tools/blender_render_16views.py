...
def _get_supported_eevee_name():
    """Return whichever Eevee identifier exists in this Blender build."""
    engines = {
...
def eevee_init():
    bpy.context.scene.render.engine = _get_supported_eevee_name()
...
if __name__ == "__main__":
    if len(sys.argv) < 1:
        ...
        process(mesh_path, types, output_path)
        exit(0)
